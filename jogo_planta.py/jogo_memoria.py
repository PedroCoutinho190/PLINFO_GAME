...
def rodar_memoria(tela):
    ...
    btn_facil   = BotaoNivel(250, 200, 300, 60, "Facil   - 4 pares")
    btn_medio   = BotaoNivel(250, 290, 300, 60, "Medio   - 6 pares")
    btn_dificil = BotaoNivel(250, 380, 300, 60, "Dificil - 8 pares")
    ...
    # Define layout das cartas
    total     = len(cartas)
    colunas   = 4 if num_pares <= 4 else (4 if num_pares == 6 else 4)
    ...
    while True:
        ...
        # Desbloqueio automático após 1 segundo
